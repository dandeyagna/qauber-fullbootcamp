...
public class InviteUser {
	...
	@Test( groups = {"Login page" }, description = "User should be able to login into the FITS with valid email id and password")
	...
	@Test( groups = {"Invite Users" }, description = "BC-518, BC-510 SA should invite Regular User with valid  email id")
	...
	@Test(dependsOnMethods={"test1"}, groups = {"Invite Users" }, description = "BC-519, BC-511 SA should not invite Regular User with invalid  email id")
	...
	@Test( groups = { "Invite Users" }, dependsOnMethods = {"test1" }, description = "BC-512, BC-520 SA should not invite Regular User with empty email id")
	...
	@Test( groups = { "Invite Users" }, dependsOnMethods = {"Test1" }, description = "BC-513 SA should not invite Regular User with empty email id")
